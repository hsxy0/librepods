...
AirPods 5 continues to skip the unused ATT connection, including with emulation
enabled, preserving the disconnect fix. Changing emulation requires a Bluetooth
